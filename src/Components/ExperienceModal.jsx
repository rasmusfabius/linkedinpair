...
class ExperienceModal extends React.Component {
    ...
    submit() {
        ...
        const experience = {startDate, role, company, area};
                        ...
                        <Row form>
                            <Col md={12}>
                                <FormGroup>
                                    ...
                                    <Input type='date' name='startDate' id='startDate' defaultValue={props.experience.startDate}
                        ...
                        <Row form>
                            <Col md={12}>
                                <FormGroup>
                                    ...
                                    <Input type='date' name='endDate' id='endDate' defaultValue={props.experience.endDate}
                                           placeholder='Full-stack Developer'/>
                                </FormGroup>
                            </Col>
                        </Row>
                            ...
                            <Col md={12}>
                                <FormGroup>
                                    ...
                                    <Input type='text' name='role' id='role'
                                           defaultValue={props.experience.role}
                                           placeholder='-'/>
                                </FormGroup>
                            </Col>
                        </Row>
                        <Row form>
                            <Col md={12}>
                                <FormGroup>
                                    ...
                                    <Input type='company' name='email' id='company'
