...
class Login extends Component {
    ...
    login = () => {
        ...
        console.log(localStorage, Api.USER, Api.PASSWORD);
            ...
            <div>
                <main className="app__content" role="main">
                    <div id="" className="text-center">
                        ...
                        <div className="header__content "><h1 className="header__content__heading">Welcome Back</h1><p
                            className="header__content__subheading">Don't miss your next opportunity. Sign in to stay
                            updated on your professional world.</p></div>
                                    ...
                                    <Col md={4} className="offset-4">
                                        <FormGroup>
                                            ...
                                            <Input type='text' name='username' id='username'
                                                   ...
                                                   placeholder='user' onChange={e => this.handleChange(e)}/>
                                        </FormGroup>
                                    </Col>
                                </Row>
                                <Row form>
                                    <Col md={4} className="offset-4">
                                        <FormGroup>
                                            ...
                                            <Input type='password' name='password' id='password'
                                                   defaultValue={props.password} onChange={e => this.handleChange(e)}/>
                                        </FormGroup>
                                    </Col>
                                </Row>
                            </Form>
                            <button onClick={this.login} className="btn__primary--large from__button--floating"
                                    type="submit"
